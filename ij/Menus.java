...
public class Menus {
	...
	String addMenuBar() {
		...
		addPlugInItem(showFolderMenu, "MorphoVision", "ij.plugin.SimpleCommands(\"showdirImageJ\")", 0, false);
		...
		addPlugInItem(help, "MorphoVision Website...", "ij.plugin.BrowserLauncher", 0, false);
		help.addSeparator();
		...
		help.addSeparator();
		addPlugInItem(help, "Update MorphoVision...", "ij.plugin.ImageJ_Updater", 0, false);
		...
		addPlugInItem(help, "About MorphoVision...", "ij.plugin.AboutBox", 0, false);
