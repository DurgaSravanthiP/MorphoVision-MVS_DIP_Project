...
<p>
MorphoVision is a work of the United States Government. It is in the public domain 
...
public class ImageJ extends Frame implements ActionListener, 
	...
	public static Color backgroundColor = MorphoTheme.BACKGROUND;
	...
	private String version() {
		return "MorphoVision "+VERSION+BUILD + "; "+"Java "+System.getProperty("java.version")+(IJ.is64Bit()?" [64-bit]; ":" [32-bit]; ");
	}
